...
.card,.block,.modal,.topbar,.config-card,.config-card-modern,.board-wrap,.screen .card,.home-library-header,.mx-home-cover,.mx-panel,.mx-game-card{
...
.btn,.btn-primary,.btn-secondary,.btn-ghost{
  min-height:46px;height:46px;padding:0 16px;border-radius:var(--mx-radius-btn);border:1px solid var(--mx-border);font-size:.92rem;font-weight:650;letter-spacing:-.01em;
}
...
.btn-secondary,.pill,.home-note-pill,.home-note-pill.is-soft,.mx-section-link,.home-games-toggle,.home-rack-arrow,.home-mobile-drawer-item{
  background:linear-gradient(180deg,rgba(255,255,255,.96) 0%,rgba(231,236,231,.86) 100%);color:var(--mx-text);border-color:var(--mx-border);
}
...
.mx-home-cover{padding:0;overflow:hidden;border-radius:28px;}
